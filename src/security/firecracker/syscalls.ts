...
export const WHITELISTED_SYSCALLS: string[] = [
  ...
  'mremap', 'msync', 'mincore', 'madvise', 'dup', 'dup2', 'pause', 'nanosleep',
  ...
  'clone', 'fork', 'vfork', 'exit', 'wait4', 'kill', 'uname', 'fcntl', 'flock',
  'fsync', 'fdatasync', 'truncate', 'ftruncate', 'getcwd', 'chdir', 'fchdir',
  'rename', 'mkdir', 'rmdir', 'creat', 'link', 'unlink', 'symlink', 'readlink',
  'chmod', 'fchmod', 'chown', 'fchown', 'lchown', 'umask', 'gettimeofday',
  'getrlimit', 'getrusage', 'sysinfo', 'times', 'getuid', 'getgid', 'setuid',
  'setgid', 'geteuid', 'getegid', 'setpgid', 'getpgrp', 'setsid', 'setreuid',
  'setregid', 'getgroups', 'setgroups', 'setresuid', 'getresuid', 'setresgid',
  'getresgid', 'getpgid', 'setfsuid', 'setfsgid', 'getsid', 'capget', 'capset',
  'sigpending', 'sigaltstack', 'prctl', 'arch_prctl', 'adjtimex', 'setrlimit',
  ...
  'query_module', 'quotactl', 'nfsservctl', 'gettid', 'readahead', 'setxattr',
  ...
  'epoll_wait', 'remap_file_pages', 'getdents64', 'set_tid_address',
  ...
  'rt_tgsigqueueinfo', 'recvmmsg', 'fanotify_init', 'fanotify_mark', 'prlimit64',
  'name_to_handle_at', 'open_by_handle_at', 'clock_adjtime', 'syncfs', 'sendmmsg',
  'setns', 'getcpu', 'process_vm_readv', 'process_vm_writev', 'kcmp',
  'finit_module', 'sched_setattr', 'sched_getattr', 'renameat2', 'seccomp',
  'getrandom', 'memfd_create', 'kexec_file_load', 'bpf', 'userfaultfd',
  ...
  'pidfd_open', 'clone3', 'openat2', 'pidfd_getfd', 'process_madvise',
...
export const BLOCKED_SYSCALLS: string[] = [
  'ptrace', 'mount', 'reboot', 'kexec_load', 'init_module', 'delete_module',
  'iopl', 'ioperm', 'process_vm_writev', 'perf_event_open', 'bpf', 'userfaultfd'
];
