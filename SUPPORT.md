...
- [README](README.md) — what the project does and how to run it.
...
| I want to… | Go here |
|---|---|
| Ask "how do I…" or "does this support…" | [GitHub Discussions](https://github.com/dirghaai/abundance-protocol/discussions) |
| Share a tip, setup, or workflow | [Discussions — Show and tell](https://github.com/dirghaai/abundance-protocol/discussions/categories/show-and-tell) |
| Report a bug | [Open an issue → Bug report](https://github.com/dirghaai/abundance-protocol/issues/new?template=bug.md) |
| Request a feature | [Open an issue → Feature request](https://github.com/dirghaai/abundance-protocol/issues/new?template=feature.md) |
...
- Include version, OS, runtime (Node / Bun / Deno) version, and any relevant environment.
- Redact API keys and any secrets from your logs.

## Commercial support

For on-premise deployment, custom integrations, SLAs, or indemnification, contact `enterprise@dirgha.ai`.
